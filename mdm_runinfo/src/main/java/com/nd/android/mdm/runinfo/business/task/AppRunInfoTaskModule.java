...
//            // 接口为空，或 5.0 以上，直接返回
//            if (systemServiceApi == null || Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//                return;
//            }
//
//            String strRunnApps = systemServiceApi.getRunningAppList().invokeMethod("getRunnApps", null);
